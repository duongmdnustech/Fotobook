...
ActiveRecord::Base.transaction do
  ...
  Photo.create!(title: "Fall in Minesota", description: "A beautiful fall scenery in Minnesota.", public_at: nil, upload_at: Time.now.getlocal("+07:00"), status: false, url: "", user_id: user2.uid, album_id: nil)
  ...
  # 5 with status: false
  Photo.create!(title: "Spring Blossoms", description: "Cherry blossoms in full bloom.", public_at: nil, upload_at: Time.now.getlocal("+07:00"), status: false, url: "", user_id: user3.uid, album_id: album3.album_id)
